Agent.receive = function () {
	...
	{
				var doubanMessage = doubanRegexp.exec(events[0].payload.events[0].douban.message) || "";
				this.createEvent({
	...
	{
				var doubanMessage = doubanRegexp.exec(events[0].payload.events[1].douban.message) || "";
				this.createEvent({
